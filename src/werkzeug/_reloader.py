...
del prefix
# Ignore __pycache__ since a change there will always have a
# change to the source file (or initial pyc file) as well.
# Ignore Git and Mercurial internal changes.
_ignore_common_dirs = {
    "__pycache__",
    ".git",
    ".hg",
